    ...
    def run
        ...
        def menu
            ...
            if user_input == 1
                ...
                puts "To view more info, enter the number of the cocktail listed above"
                ...
                puts ""
                puts "Enter the number of the technique listed above."
